 ...
 */
struct ompi_osc_base_component_3_0_0_t {
...
typedef struct ompi_osc_base_component_3_0_0_t ompi_osc_base_component_3_0_0_t;
typedef ompi_osc_base_component_3_0_0_t ompi_osc_base_component_t;


/* ******************************************************************** */

typedef int (*ompi_osc_base_module_win_shared_query_fn_t)(struct ompi_win_t *win, int rank,
                                                          size_t *size, ptrdiff_t *disp_unit, void *baseptr);
...
#define OMPI_OSC_BASE_VERSION_4_0_0 \
    OMPI_MCA_BASE_VERSION_2_1_0("osc", 4, 0, 0)
