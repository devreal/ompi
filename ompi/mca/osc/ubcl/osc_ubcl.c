...
static int shared_query(struct ompi_win_t *win, int rank, size_t *size, ptrdiff_t *disp_unit,
                        void *baseptr);
...
int osc_ubcl_build_ddt_iov(const void *addr, ompi_proc_t *proc, size_t count,
