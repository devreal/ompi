 ...
 * Declared in op_rocm_kernels.cpp; populated by ompi_op_rocm_kernel_fns_init().
 */
OMPI_DECLSPEC extern ompi_op_rocm_launcher_fn_t
ompi_op_rocm_kernel_fns[OMPI_OP_BASE_FORTRAN_OP_MAX][OMPI_OP_BASE_TYPE_MAX];

/** Populate ompi_op_rocm_kernel_fns. Called once from rocm_component_open(). */
OMPI_DECLSPEC void ompi_op_rocm_kernel_fns_init(void);
