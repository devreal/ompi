 ...
 *
 * The table is zero-initialized here; ompi_op_rocm_kernel_fns_init() fills
 * in the non-NULL entries at component open time.  This avoids designated
 * initializers, which are C99/C11 and not supported by hipcc in C++ mode.
 * ========================================================================= */
...
#define SET(op, type, fn) \
    ompi_op_rocm_kernel_fns[OMPI_OP_BASE_FORTRAN_##op][OMPI_OP_BASE_TYPE_##type] = launch_##fn
